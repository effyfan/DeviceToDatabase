  ...
  if (millis() - lastMillis > publishInterval) {
   ...
   if (millis() - lastMillis > soundInterval) {
    ...
    if (abs(lastPhotocellReading - photocellReading) > 3) {
      ...
      mqttClient.print(photocellReading);
      mqttClient.print("}");
      mqttClient.endMessage();
    ...
    if (vibrationReading != lastVibrationReading) {
      ...
      mqttClient.beginMessage("things/" + clientId + "/environment");
      mqttClient.print("{");
      mqttClient.print("\"vibration\":");
      mqttClient.print(vibrationReading);
      mqttClient.print("}");
    ...
    if (motionReading != lastMotionReading) {
      ...
      mqttClient.print(motionReading);
      mqttClient.print("}");
